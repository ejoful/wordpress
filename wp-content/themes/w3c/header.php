...
<head>
<meta charset="utf-8" />
<title>javascript教程_w3cschool</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<meta name="renderer" content="webkit" />
<meta name="viewport" content="width=device-width,initial-scale=1.0">
<meta name="keywords" content="javascript教程" /> 
<meta name="description" content="JavaScript 是世界上最流行的脚本语言。
JavaScript 是属于 web 的语言，它适用于 PC、笔记本电脑、平板电脑和移动电话。
JavaScript 被设计为向 HTML 页面增加交互性。
许多 HTML 开发者都不是程序员，但是 JavaScript 却拥有非常简单的语法。几乎每个人都有能力将小的 JavaScript 片段添加到网页中。_来自javascript教程，w3cschool。" />
<link rel="stylesheet" href="//www.w3cschool.cn/statics/css/w3.css?v=1.21" />
<link rel="stylesheet" href="//www.w3cschool.cn/statics/css/project.css?v=1.21" />
...
<script src="//www.w3cschool.cn/statics/plugins/jquery.cookie.min.js" type="text/javascript"></script>
</head>
<body id="homefirst">
<!--引入头部-->
<!--header start--> 
...
<div id="header_index">
<div id="header-l">
<a href="http://www.w3cschool.cn" title="w3cschool" class="logo"><img src="http://statics.w3cschool.cn/images/w3c/logo.png" alt="W3Cschool" /></a>
<ul class="header-menu">
<li><a href="http://www.w3cschool.cn/tutorial" title="编程入门教程" >编程入门教程</a></li>
